...
const YearPhotoAlbum = ({ year }: Props) => {
  ...
  useEffect(() => {
    ...
    Promise.all(imgSrcPromises).then((data) => {
      updateData(data);
    });
  }, []);
  ...
  switch (year) {
    case 2021:
      return Object.values(
        import.meta.glob(
          `/src/assets/2021/small/thumbnail/*.{png,jpg,JPG,jpeg,PNG,JPEG}`,
          {
            eager: true,
            as: "url",
          }
    ...
    case 2022:
      return Object.values(
        import.meta.glob(
          `/src/assets/2022/small/thumbnail/*.{png,jpg,JPG,jpeg,PNG,JPEG}`,
          {
            eager: true,
            as: "url",
          }
    ...
    case 2023:
      return Object.values(
        import.meta.glob(
          `/src/assets/2023/small/thumbnail/*.{png,jpg,JPG,jpeg,PNG,JPEG}`,
          {
            eager: true,
            as: "url",
          }
...
const importImagesGlob = (year: number) => {
  switch (year) {
    case 2021:
      return Object.values(
        import.meta.glob(
          `/src/assets/2021/small/*.{png,jpg,JPG,jpeg,PNG,JPEG}`,
          {
            eager: true,
            as: "url",
          }
    ...
    case 2022:
      return Object.values(
        import.meta.glob(
          `/src/assets/2022/small/*.{png,jpg,JPG,jpeg,PNG,JPEG}`,
          {
            eager: true,
            as: "url",
          }
